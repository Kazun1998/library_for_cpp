...
data:
  ...
  attributes:
    document_title: "\u533A\u9593 [l, r] \u5185\u306E\u3059\u3079\u3066\u306E\u6574\
      \u6570\u306E\u7D20\u56E0\u6570\u5206\u89E3\u3092\u8A08\u7B97\u3059\u308B."
    links: []
  bundledCode: "#line 2 \"Integer/Interval_Prime_Factorization.hpp\"\n\n#line 2 \"\
    ...
    \ 5 \"Integer/Interval_Prime_Factorization.hpp\"\n\n/**\n * @brief \u533A\u9593\
    \ [l, r] \u5185\u306E\u3059\u3079\u3066\u306E\u6574\u6570\u306E\u7D20\u56E0\u6570\
    \u5206\u89E3\u3092\u8A08\u7B97\u3059\u308B.\n * @param l \u533A\u9593\u306E\u4E0B\
    \u9650 (0 <= l)\n * @param r \u533A\u9593\u306E\u4E0A\u9650 (l <= r)\n * @return\
    \ vector<vector<pair<ll, int>>> \u7D20\u56E0\u6570\u5206\u89E3\u7D50\u679C\u306E\
    \u30EA\u30B9\u30C8.\n *         \u623B\u308A\u5024\u306E i \u756A\u76EE\u306E\u8981\
    \u7D20\u306F, \u5024 (l + i) \u306E\u7D20\u56E0\u6570\u5206\u89E3 (\u7D20\u56E0\
    \u6570, \u6307\u6570) \u306E\u30EA\u30B9\u30C8.\n */\nvector<vector<pair<ll, int>>>\
    \ Interval_Prime_Factorization(ll l, ll r) {\n    const ll offset = l;\n    const\
    ...
    \ + p - 1) / p * p; x <= r; x += p) {\n            int e = 0;\n            while\
    \ (remain[x - offset] % p == 0) {\n                remain[x - offset] /= p;\n\
    \                e++;\n            }\n            factors[x - offset].emplace_back(p,\
    \ e);\n        }\n    }\n\n    for (ll x = l; x <= r; ++x) {\n        unless (remain[x\
    \ - offset] == 1) {\n            factors[x - offset].emplace_back(remain[x - offset],\
    \ 1);\n        }\n    }\n\n    return factors;\n}\n"
  code: "#pragma once\n\n#include \"../template/template.hpp\"\n#include \"Prime.hpp\"\
    \n\n/**\n * @brief \u533A\u9593 [l, r] \u5185\u306E\u3059\u3079\u3066\u306E\u6574\
    \u6570\u306E\u7D20\u56E0\u6570\u5206\u89E3\u3092\u8A08\u7B97\u3059\u308B.\n *\
    \ @param l \u533A\u9593\u306E\u4E0B\u9650 (0 <= l)\n * @param r \u533A\u9593\u306E\
    \u4E0A\u9650 (l <= r)\n * @return vector<vector<pair<ll, int>>> \u7D20\u56E0\u6570\
    \u5206\u89E3\u7D50\u679C\u306E\u30EA\u30B9\u30C8.\n *         \u623B\u308A\u5024\
    \u306E i \u756A\u76EE\u306E\u8981\u7D20\u306F, \u5024 (l + i) \u306E\u7D20\u56E0\
    \u6570\u5206\u89E3 (\u7D20\u56E0\u6570, \u6307\u6570) \u306E\u30EA\u30B9\u30C8\
    ...
    \ offset] /= p;\n                e++;\n            }\n            factors[x -\
    \ offset].emplace_back(p, e);\n        }\n    }\n\n    for (ll x = l; x <= r;\
    \ ++x) {\n        unless (remain[x - offset] == 1) {\n            factors[x -\
    \ offset].emplace_back(remain[x - offset], 1);\n        }\n    }\n\n    return\
    \ factors;\n}"
  dependsOn:
  - template/template.hpp
  ...
  verifiedWith: []
documentation_of: Integer/Interval_Prime_Factorization.hpp
layout: document
title: "\u533A\u9593\u7BE9\u306B\u3088\u308B\u7D20\u56E0\u6570\u5206\u89E3"
---
...
区間篩による連続する整数における素因数分解を行う.

## History

|日付|内容|
|:---:|:---|
|2026/04/29| Interval_Prime_Factorization の実装 |
