...
data:
  ...
  bundledCode: "#line 2 \"Segment_Tree/preset/Range_Min.hpp\"\n\n#line 2 \"Segment_Tree/Segment_Tree.hpp\"\
    ...
    template<typename T>\nclass Range_Min_Segment_Tree : public Segment_Tree<T, T(*)(T,\
    \ T)> {\n    static T op(T x, T y) { return x < y ? x : y; }\n\n    public:\n\
    \    Range_Min_Segment_Tree(int n, T unit) : Segment_Tree<T, T(*)(T, T)>(n, op,\
    \ unit) {}\n\n    Range_Min_Segment_Tree(const vector<T> &vec, T unit) : Segment_Tree<T,\
  ...
  code: "#pragma once\n\n#include \"../Segment_Tree.hpp\"\n\ntemplate<typename T>\n\
    class Range_Min_Segment_Tree : public Segment_Tree<T, T(*)(T, T)> {\n    static\
