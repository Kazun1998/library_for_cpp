...
data:
  ...
  attributes:
    document_title: "i \u306E\u5DE6\u306E\u5B50\u3068\u3057\u3066 j \u3092\u8A2D\u5B9A\
      \u3059\u308B"
    links: []
  bundledCode: "#line 2 \"Sequence/Cartesian_Tree.hpp\"\n\n#line 2 \"template/template.hpp\"\
    \n\nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n#include\
    \ <algorithm>\n#include <array>\n#include <bitset>\n#include <cassert>\n#include\
    \ <cctype>\n#include <cfenv>\n#include <cfloat>\n#include <chrono>\n#include <cinttypes>\n\
    #include <climits>\n#include <cmath>\n#include <complex>\n#include <concepts>\n\
    ...
    \ vector<O> &data, bool reversal = false): left(data.size(), -1), right(data.size(),\
    \ -1), parent(data.size(), -1), root(-1), reversal(reversal) {\n        build_up(data);\n\
...
documentation_of: Sequence/Cartesian_Tree.hpp
layout: document
redirect_from:
- /library/Sequence/Cartesian_Tree.hpp
- /library/Sequence/Cartesian_Tree.hpp.html
title: "i \u306E\u5DE6\u306E\u5B50\u3068\u3057\u3066 j \u3092\u8A2D\u5B9A\u3059\u308B"
---
