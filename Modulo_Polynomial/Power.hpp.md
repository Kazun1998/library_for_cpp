...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Modulo_Polynomial/Power.hpp\"\n\n#line 2 \"Modulo_Polynomial/Exp.hpp\"\
    ...
    \    for (; G.precision < n;) {\n        G.precision *= 2;\n        G = G * (one\
    \ - Log(G) + A);\n    }\n\n    return G;\n}\n#line 4 \"Modulo_Polynomial/Power.hpp\"\
    \n\n// A \u306E M \u4E57\u3092\u6C42\u3081\u308B.\ntemplate<const ll Mod>\nFast_Power_Series<Mod>\
    \ pow(Fast_Power_Series<Mod> &A, ll M) {\n    using mint = modint<Mod>;\n    using\
    \ FPS = Fast_Power_Series<Mod>;\n\n    // M = 0 \u306E\u3068\u304D\u306F, A^0\
    \ = 1 \u304C\u78BA\u5B9A\n    if (M == 0) { return Fast_Power_Series<Mod>({1},\
    \ A.precision); }\n\n    int ord = A.order();\n\n    // A = 0 \u306E\u3068\u304D\
    \u306F, M != 0 \u3088\u308A, A^M = 0 \u304C\u78BA\u5B9A\n    if (ord == -1) {\
    \ return Fast_Power_Series<Mod>(A.precision); }\n\n    // ord(A^M) = M ord(A)\
    \ \u3067\u3042\u308B. M ord(A) > n \u306A\u3089\u3070, A^M = 0 (mod X^n) \u306B\
    \u306A\u308B.\n    if (ord > A.precision / M) { return Fast_Power_Series<Mod>(A.precision);\
    ...
    \n    Fast_Power_Series<Mod> G(g);\n    G *= content_m;\n\n    return G;\n}\n"
  code: "#pragma once\n\n#include\"Exp.hpp\"\n\n// A \u306E M \u4E57\u3092\u6C42\u3081\
    \u308B.\ntemplate<const ll Mod>\nFast_Power_Series<Mod> pow(Fast_Power_Series<Mod>\
    \ &A, ll M) {\n    using mint = modint<Mod>;\n    using FPS = Fast_Power_Series<Mod>;\n\
    \n    // M = 0 \u306E\u3068\u304D\u306F, A^0 = 1 \u304C\u78BA\u5B9A\n    if (M\
    \ == 0) { return Fast_Power_Series<Mod>({1}, A.precision); }\n\n    int ord =\
    \ A.order();\n\n    // A = 0 \u306E\u3068\u304D\u306F, M != 0 \u3088\u308A, A^M\
    \ = 0 \u304C\u78BA\u5B9A\n    if (ord == -1) { return Fast_Power_Series<Mod>(A.precision);\
    \ }\n\n    // ord(A^M) = M ord(A) \u3067\u3042\u308B. M ord(A) > n \u306A\u3089\
    \u3070, A^M = 0 (mod X^n) \u306B\u306A\u308B.\n    if (ord > A.precision / M)\
    \ { return Fast_Power_Series<Mod>(A.precision); }\n\n    mint content = A[ord];\n\
    \    mint content_inv = content.inverse();\n    mint content_m = pow(content,\
    \ M);\n\n    M %= Mod;\n\n    vector<mint> b(A.precision - ord);\n    for (int\
    \ d = ord; d < A.precision; d++) { b[d - ord] = A[d] * content_inv; }\n    FPS\
...
documentation_of: Modulo_Polynomial/Power.hpp
layout: document
redirect_from:
- /library/Modulo_Polynomial/Power.hpp
- /library/Modulo_Polynomial/Power.hpp.html
