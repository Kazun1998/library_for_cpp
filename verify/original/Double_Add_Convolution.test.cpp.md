...
data:
  ...
  bundledCode: "#line 1 \"verify/original/Double_Add_Convolution.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    ...
    \    }\n};\n#line 2 \"Convolution/Double_Add_Convolution.hpp\"\n\n#line 4 \"Convolution/Double_Add_Convolution.hpp\"\
    \n\nnamespace convolution {\n    // \u6D6E\u52D5\u5C0F\u6570\u70B9\u6570 (double)\
    \ \u306E\u7573\u307F\u8FBC\u307F\u3092 FFT \u3067\u8A08\u7B97\u3059\u308B.\n \
    \   // \u8AA4\u5DEE\u3092\u542B\u3080\u305F\u3081, \u53B3\u5BC6\u306A\u6574\u6570\
    \u7573\u307F\u8FBC\u307F\u306B\u306F Numeric_Theory_Translation \u7B49\u3092\u4F7F\
    ...
    \ >>= 1) { j ^= bit; }\n                j ^= bit;\n                if (i < j)\
    \ { swap(A[i], A[j]); }\n            }\n\n            for (int len = 2; len <=\
    \ N; len <<= 1) {\n                double ang = 2 * M_PI / len * (inverse ? -1\
    ...
    \                 w *= wlen;\n                    }\n                }\n     \
    \       }\n\n            if (inverse) {\n                for (Complex &x: A) {\
    \ x /= N; }\n            }\n        }\n\n        public:\n        Double_Add_Convolution()\
    \ = default;\n\n        // \u5185\u90E8\u3067 double \u3092\u7528\u3044\u3066\u8A08\
    \u7B97\u3059\u308B (\u8AA4\u5DEE\u306B\u3088\u308A\u53B3\u5BC6\u6027\u306F\u4FDD\
    \u8A3C\u3055\u308C\u306A\u3044).\n        static vector<ll> convolution(const\
    ...
    \ }\n            return C;\n        }\n    };\n}\n#line 5 \"verify/original/Double_Add_Convolution.test.cpp\"\
    \n\nusing convolution::Double_Add_Convolution;\n\nvector<ll> naive_convolution(const\
    \ vector<ll> &A, const vector<ll> &B) {\n    if (A.empty() || B.empty()) { return\
    \ {}; }\n\n    vector<ll> C(A.size() + B.size() - 1, 0);\n    for (size_t i =\
    \ 0; i < A.size(); i++) {\n        for (size_t j = 0; j < B.size(); j++) {\n \
    \           C[i + j] += A[i] * B[j];\n        }\n    }\n    return C;\n}\n\nvoid\
    \ verify() {\n    // \u7A7A\u914D\u5217\n    {\n        assert(Double_Add_Convolution::convolution({},\
    \ {1, 2, 3}).empty());\n        assert(Double_Add_Convolution::convolution({1,\
    \ 2, 3}, {}).empty());\n    }\n\n    // \u5C0F\u3055\u306A\u4F8B\n    {\n    \
    \    vector<ll> A{1, 2, 3}, B{4, 5, 6};\n        vector<ll> C = Double_Add_Convolution::convolution(A,\
  ...
  requiredBy: []
  timestamp: '2026-09-20 19:11:32+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/original/Double_Add_Convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/original/Double_Add_Convolution.test.cpp
- /verify/verify/original/Double_Add_Convolution.test.cpp.html
