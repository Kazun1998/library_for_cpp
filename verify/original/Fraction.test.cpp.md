...
data:
  ...
  bundledCode: "#line 1 \"verify/original/Fraction.test.cpp\"\n#define PROBLEM \"\
    https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\n\n#line\
    ...
    \      assert(a > c);\n        assert(a >= b);\n        assert(a <= b);\n    }\n\
    \n    // Unary -\n    {\n        Fraction<long long> a(1, 2);\n        assert(-a\
    \ == Fraction<long long>(-1, 2));\n    }\n\n    // inv\n    {\n        Fraction<long\
    \ long> a(2, 3);\n        assert(a.inv() == Fraction<long long>(3, 2));\n    }\n\
    \n    // abs\n    {\n        Fraction<long long> a(-1, 2);\n        assert(abs(a)\
    \ == Fraction<long long>(1, 2));\n        assert(abs(Fraction<long long>(1, 2))\
    \ == Fraction<long long>(1, 2));\n    }\n\n    // pow\n    {\n        Fraction<long\
    \ long> a(2, 3);\n        assert(pow(a, 0) == Fraction<long long>(1));\n     \
    \   assert(pow(a, 1) == a);\n        assert(pow(a, 2) == Fraction<long long>(4,\
    \ 9));\n        assert(pow(a, -1) == Fraction<long long>(3, 2));\n        assert(pow(a,\
    \ -2) == Fraction<long long>(9, 4));\n    }\n\n    // to_double\n    {\n     \
    \   Fraction<long long> a(1, 2);\n        assert(std::abs(a.to_double() - 0.5)\
    \ < 1e-9);\n    }\n}\n\nint main() {\n    verify();\n    cout << \"Hello World\"\
    \ << endl;\n}\n"
  ...
  - Algebra/Fraction.hpp
  isVerificationFile: true
  path: verify/original/Fraction.test.cpp
  requiredBy: []
  timestamp: '2026-01-25 01:38:34+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/original/Fraction.test.cpp
layout: document
redirect_from:
- /verify/verify/original/Fraction.test.cpp
- /verify/verify/original/Fraction.test.cpp.html
