...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/7D.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_D\"\n#define\
    ...
    #line 2 \"Geometry/Intersection_Circle_and_Line.hpp\"\n\n#line 2 \"Geometry/Projection_Point_Line.hpp\"\
    ...
    \ Point<R> vectorize() const { return B - A; }\n        inline Point<R> counter_vectorize()\
    \ const { return A - B; }\n\n        Inclusion include(const Point<R> &P) {\n\
    \            int m = Counter_Clockwise(A, B, P);\n            return (m == ON_SEGMENT\
    \ || m == ONLINE_BACK || m == ONLINE_FRONT) ? Inclusion::ON : Inclusion::OUT;\n\
    \        }\n    };\n}\n#line 4 \"Geometry/Projection_Point_Line.hpp\"\n\nnamespace\
    \ geometry {\n    template<typename R>\n    Point<R> Projection(const Point<R>\
    \ &P, const Line<R> &l) {\n        auto d = l.vectorize();\n        auto t = dot(P\
    ...
    \    return { H + x * e, H - x * e };\n    }\n}\n#line 6 \"verify/aizu_online_judge/cgl/7D.test.cpp\"\
    \n\nusing namespace geometry;\n\nint main() {\n    cout << fixed << setprecision(15);\n\
    \    Point<Real> c;\n    Real r;\n    cin >> c >> r;\n    Circle<Real> C(c, r);\n\
    \n    int Q; cin >> Q;\n    for (int q = 1; q <= Q; q++) {\n        Point<Real>\
    \ A, B; cin >> A >> B;\n        Line<Real> l(A, B);\n\n        vector<Point<Real>>\
    \ intersections = Intersection(C, l);\n        unless(compare_x(intersections[0],\
    \ intersections[1])) {\n            swap(intersections[0], intersections[1]);\n\
    \        }\n\n        cout << intersections[0] << \" \" << intersections[1] <<\
    \ endl;\n    }\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_D\"\
    ...
    \nint main() {\n    cout << fixed << setprecision(15);\n    Point<Real> c;\n \
    \   Real r;\n    cin >> c >> r;\n    Circle<Real> C(c, r);\n\n    int Q; cin >>\
    \ Q;\n    for (int q = 1; q <= Q; q++) {\n        Point<Real> A, B; cin >> A >>\
    \ B;\n        Line<Real> l(A, B);\n\n        vector<Point<Real>> intersections\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/7D.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/7D.test.cpp
- /verify/verify/aizu_online_judge/cgl/7D.test.cpp.html
