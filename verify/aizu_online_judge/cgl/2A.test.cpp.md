...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/2A.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_A\"\n\n#line\
    ...
    \ }\n        return Direction_Relation::CROSS;\n    }\n};\n#line 5 \"verify/aizu_online_judge/cgl/2A.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/2A.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/2A.test.cpp
- /verify/verify/aizu_online_judge/cgl/2A.test.cpp.html
