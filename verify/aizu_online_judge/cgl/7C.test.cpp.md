...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/7C.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_C\"\n#define\
    ...
    #line 2 \"Geometry/Circumcircle.hpp\"\n\n#line 2 \"Geometry/Circle.hpp\"\n\n#line\
    ...
    \  }\n}\n#line 6 \"verify/aizu_online_judge/cgl/7C.test.cpp\"\n\nusing namespace\
    \ geometry;\n\nint main() {\n    cout << fixed << setprecision(15);\n    Point<Real>\
    \ A, B, C; cin >> A >> B >> C;\n    auto X = Circumcircle(Triangle<Real>(A, B,\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_C\"\
    ...
    \ {\n    cout << fixed << setprecision(15);\n    Point<Real> A, B, C; cin >> A\
    \ >> B >> C;\n    auto X = Circumcircle(Triangle<Real>(A, B, C));\n    cout <<\
    \ X.center << \" \" << X.radius << endl;\n}\n"
  dependsOn:
  - template/template.hpp
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/7C.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/7C.test.cpp
- /verify/verify/aizu_online_judge/cgl/7C.test.cpp.html
