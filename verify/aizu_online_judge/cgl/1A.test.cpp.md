...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/1A.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_A\"\n#define\
    ...
    \ 6 \"verify/aizu_online_judge/cgl/1A.test.cpp\"\n\nusing namespace geometry;\n\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/1A.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/1A.test.cpp
- /verify/verify/aizu_online_judge/cgl/1A.test.cpp.html
