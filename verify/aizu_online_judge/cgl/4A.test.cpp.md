...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/4A.test.cpp\"\n#define PROBLEM\
    ...
    \               k--;\n            }\n        }\n\n        vertices.resize(k -\
    \ 1);\n        return Polygon(vertices);\n    }\n}\n#line 5 \"verify/aizu_online_judge/cgl/4A.test.cpp\"\
    \n\nusing namespace geometry;\n\nint main() {\n\n    int n; cin >> n;\n    vector<Point<int>>\
    \ points(n); cin >> points;\n\n    auto X = Convex_Hull(points, false);\n\n  \
    \  int argmin = 0;\n    for (int i = 1; i < X.n; i++) {\n        if (compare_y(X.vertices[i],\
    \ X.vertices[argmin])) { argmin = i; }\n    }\n\n    cout << X.n << endl;\n  \
    \  for (int k = 0; k < X.n; k++) {\n        cout << X.vertices[(k + argmin) %\
    \ X.n] << endl;\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/4A.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/4A.test.cpp
- /verify/verify/aizu_online_judge/cgl/4A.test.cpp.html
