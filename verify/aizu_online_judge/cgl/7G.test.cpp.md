...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/7G.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_G\"\n#define\
    ...
    #line 2 \"Geometry/Common_Tangent_Points.hpp\"\n\n#line 2 \"Geometry/Circle.hpp\"\
    ...
    \ }\n        }\n\n        return tangents;\n    }\n}\n#line 6 \"verify/aizu_online_judge/cgl/7G.test.cpp\"\
    \n\nusing namespace geometry;\n\nint main() {\n    cout << fixed << setprecision(15);\n\
    \n    Point<Real> p, q;\n    Real r, s;\n\n    cin >> p >> r >> q >> s;\n\n  \
    \  Circle<Real> C(p, r), D(q, s);\n\n    auto tangents = Common_Tangent_Points(C,\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/7/CGL_7_G\"\
    ...
    int main() {\n    cout << fixed << setprecision(15);\n\n    Point<Real> p, q;\n\
    \    Real r, s;\n\n    cin >> p >> r >> q >> s;\n\n    Circle<Real> C(p, r), D(q,\
    \ s);\n\n    auto tangents = Common_Tangent_Points(C, D);\n    sort(tangents.begin(),\
    \ tangents.end(), compare_x<Real>);\n    for (auto tangent: tangents) {\n    \
    \    cout << tangent << endl;\n    }\n}\n"
  dependsOn:
  - template/template.hpp
  ...
  requiredBy: []
  timestamp: '2025-09-21 12:28:22+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/7G.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/7G.test.cpp
- /verify/verify/aizu_online_judge/cgl/7G.test.cpp.html
