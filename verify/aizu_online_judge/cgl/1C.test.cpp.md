...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/1C.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C\"\n\n#line\
    ...
    #line 5 \"verify/aizu_online_judge/cgl/1C.test.cpp\"\n\nusing namespace geometry;\n\
    \nint main() {\n    using namespace geometry;\n    Point<ll> A, B; cin >> A >>\
    \ B;\n\n    int Q; cin >> Q;\n    for (int  q = 0; q < Q; q++) {\n        Point<ll>\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/1C.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/1C.test.cpp
- /verify/verify/aizu_online_judge/cgl/1C.test.cpp.html
