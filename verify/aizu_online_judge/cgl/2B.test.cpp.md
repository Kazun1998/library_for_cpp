...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/cgl/2B.test.cpp\"\n#define PROBLEM\
    ...
    \ bit_length(x)); }\n#line 2 \"Geometry/intersection/Intersection_Segment_and_Segment.hpp\"\
    ...
    \ k * (b - a); \n    }\n}\n#line 5 \"verify/aizu_online_judge/cgl/2B.test.cpp\"\
    \n\nusing namespace geometry;\n\nint main() {\n    using namespace geometry;\n\
    \n    int Q; cin >> Q;\n    for (int q = 0; q < Q; q++) {\n        Segment<int>\
    \ s, t; cin >> s.A >> s.B >> t.A >> t.B;\n\n        cout << has_Intersection(s,\
    \ t) << endl;\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/cgl/2B.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/cgl/2B.test.cpp
- /verify/verify/aizu_online_judge/cgl/2B.test.cpp.html
