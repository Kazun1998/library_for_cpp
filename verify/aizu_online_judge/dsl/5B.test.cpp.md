...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dsl/5B.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/5/DSL_5_B\"\n\n#line\
    ...
    \ 5 \"verify/aizu_online_judge/dsl/5B.test.cpp\"\n\nint verify() {\n    int N;\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/5/DSL_5_B\"\
    ...
    \n\nint verify() {\n    int N; cin >> N;\n    int R = 1000;\n\n    Imos_2<int>\
    \ I(R + 1, R + 1);\n\n    for (int i = 1; i <= N; ++i) {\n        int x1, y1,\
    \ x2, y2; scanf(\"%d%d%d%d\", &x1, &y1, &x2, &y2);\n        I.add(x1, x2 - 1,\
    \ y1, y2 - 1);\n    }\n\n    auto J = I.cumulate();\n\n    int ans = 0;\n    for\
    \ (int i = 0; i <= R; ++i) {\n        chmax(ans, max(J[i]));\n    }\n\n    return\
    \ ans;\n}\n\nint main() {\n    cout << verify() << endl;\n}\n"
  dependsOn:
  ...
  requiredBy: []
  timestamp: '2026-05-28 01:19:48+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dsl/5B.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dsl/5B.test.cpp
- /verify/verify/aizu_online_judge/dsl/5B.test.cpp.html
