...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dsl/2G_2.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_G\"\n\n#line\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Segment_Tree/preset/Range_Add_Range_Sum.hpp\"\
    ...
    * F: Monoid\n* op: M x M \u2192 M: M \u4E0A\u306E\u6F14\u7B97\n* unit: M \u306E\
    ...
    \ r).first; }\n};\n#line 5 \"verify/aizu_online_judge/dsl/2G_2.test.cpp\"\n\n\
    int main() {\n    int n, q; cin >> n >> q;\n\n    Range_Add_Range_Sum_Lazy_Segment_Tree<ll>\
    \ S(n + 1);\n    for (int r = 1; r <= q; r++) {\n        int p; scanf(\"%d\",\
    \ &p);\n        if (p == 0) {\n            int s, t; ll x; scanf(\"%d%d%lld\"\
    , &s, &t, &x);\n            S.add(s, t, x);\n        } else if (p == 1) {\n  \
  ...
  requiredBy: []
  timestamp: '2026-01-18 13:06:15+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dsl/2G_2.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dsl/2G_2.test.cpp
- /verify/verify/aizu_online_judge/dsl/2G_2.test.cpp.html
