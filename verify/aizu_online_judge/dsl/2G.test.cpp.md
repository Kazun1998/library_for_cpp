...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dsl/2G.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_G\"\n\n#line\
    ...
    \ sum(k, k); }\n};\n#line 5 \"verify/aizu_online_judge/dsl/2G.test.cpp\"\n\nint\
    \ main() {\n    int n, q; cin >> n >> q;\n\n    Range_Binary_Indexed_Tree<ll>\
    \ B(n + 1, add<ll>, 0LL, neg<ll>, mul<ll>);\n    for (int r = 1; r <= q; r++)\
    \ {\n        int p; scanf(\"%d\", &p);\n        if (p == 0) {\n            int\
    \ s, t; ll x; scanf(\"%d%d%lld\", &s, &t, &x);\n            B.add(s, t, x);\n\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dsl/2G.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dsl/2G.test.cpp
- /verify/verify/aizu_online_judge/dsl/2G.test.cpp.html
