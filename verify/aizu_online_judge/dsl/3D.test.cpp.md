...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dsl/3D.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/3/DSL_3_D\"\n\n#line\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Calculate/Slide_Maximum.hpp\"\
    \n\n#line 4 \"Calculate/Slide_Maximum.hpp\"\n\ntemplate<typename T>\nvector<int>\
    \ Slide_Maximum_Index(const vector<T>& data, const int k) {\n    const int n =\
    \ data.size();\n    std::vector<int> index(n);\n    deque<T> Q;\n\n    for (int\
    \ i = 0; i < n; ++i) {\n        if (!Q.empty() && Q.front() <= i - k) Q.pop_front();\n\
    \n        while (!Q.empty() && data[Q.back()] < data[i]) Q.pop_back();\n\n   \
    \     Q.push_back(i);\n        index[i] = Q.front();\n    }\n\n    return vector<int>(index.begin()\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dsl/3D.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dsl/3D.test.cpp
- /verify/verify/aizu_online_judge/dsl/3D.test.cpp.html
