...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dsl/5A.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/5/DSL_5_A\"\n\n#line\
    ...
    \ res(lazy.begin(), lazy.end());\n        for (int i = 1; i < n; ++i) res[i] +=\
    \ res[i - 1];\n\n        return res;\n    }\n\n    /// @brief \u5185\u90E8\u72B6\
    \u614B\u3092\u30AF\u30EA\u30A2\u3057\u3066\u3001\u518D\u5EA6 add \u3067\u304D\u308B\
    \u72B6\u614B\u306B\u3059\u308B\n    void clear() {\n        std::fill(lazy.begin(),\
    \ lazy.end(), T(0));\n    }\n};\n#line 5 \"verify/aizu_online_judge/dsl/5A.test.cpp\"\
    \n\nint verify() {\n    int N, T; cin >> N >> T;\n\n    Imos_1<int> I(T + 1);\n\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dsl/5A.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dsl/5A.test.cpp
- /verify/verify/aizu_online_judge/dsl/5A.test.cpp.html
