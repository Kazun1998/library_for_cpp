...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/grl/4B.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/5/GRL/4/GRL_4_B\"\n\n#line\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Others/Topological_Sort.hpp\"\
    ...
    \u308B\n     * @return true DAG\u3067\u3042\u308B\n     * @return false DAG\u3067\
    \u306A\u3044 (\u9589\u8DEF\u304C\u5B58\u5728\u3059\u308B)\n     */\n    bool is_DAG()\
    \ const { return sort() != nullopt; }\n};\n#line 5 \"verify/aizu_online_judge/grl/4B.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/grl/4B.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/grl/4B.test.cpp
- /verify/verify/aizu_online_judge/grl/4B.test.cpp.html
