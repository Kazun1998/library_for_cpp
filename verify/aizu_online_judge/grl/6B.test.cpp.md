...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/grl/6B.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=GRL_6_B\"\n\n#line\
    ...
    \ Cost>(n, -1) {}\n    };\n}\n#line 5 \"verify/aizu_online_judge/grl/6B.test.cpp\"\
    \n\nint main() {\n    int V, E, F; cin >> V >> E >> F;\n    min_cost_flow::Min_Cost_Flow<int,\
    \ int> X(V);\n\n    for (int j = 0; j < E; ++j) {\n        int u, v, c, d; cin\
    \ >> u >> v >> c >> d;\n        X.add_arc(u, v, c, d);\n    }\n\n    cout << X.flow(0,\
    \ V - 1, F).value_or(-1) << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/grl/6B.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/grl/6B.test.cpp
- /verify/verify/aizu_online_judge/grl/6B.test.cpp.html
