...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dpl1/1H.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/1/DPL_1_H\"\n\n#line\
    ...
    \ + i] = 1;\n\n            return Solution<I, V, W, Q>(items, knapsack);\n   \
    \     }\n    };\n}\n#line 5 \"verify/aizu_online_judge/dpl1/1H.test.cpp\"\n\n\
    using namespace knapsack_problem;\n\n\nint main() {\n    int N; ll W; cin >> N\
    \ >> W;\n    vector<Item<int, ll, ll>> items(N);\n    for (int i = 0; i < N; ++i)\
    \ {\n        cin >> items[i].value >> items[i].weight;\n    }\n\n    cout << Knapsack_01<int,\
    \ ll, ll, int>::solve_meet_in_the_middle(items, W).total_value << endl;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/1/DPL_1_H\"\
    \n\n#include\"../../../template/template.hpp\"\n#include\"../../../Knapsack/Knapsack_01.hpp\"\
    \n\nusing namespace knapsack_problem;\n\n\nint main() {\n    int N; ll W; cin\
    \ >> N >> W;\n    vector<Item<int, ll, ll>> items(N);\n    for (int i = 0; i <\
    \ N; ++i) {\n        cin >> items[i].value >> items[i].weight;\n    }\n\n    cout\
    \ << Knapsack_01<int, ll, ll, int>::solve_meet_in_the_middle(items, W).total_value\
    \ << endl;\n}"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dpl1/1H.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dpl1/1H.test.cpp
- /verify/verify/aizu_online_judge/dpl1/1H.test.cpp.html
