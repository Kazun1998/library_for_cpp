...
data:
  ...
  bundledCode: "#line 1 \"verify/aizu_online_judge/dpl1/1C.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/7/DPL/1/DPL_1_C\"\n\n#line\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Knapsack/Knapsack_Infinity.hpp\"\
    ...
    \ - 1]++;\n                }\n            }\n\n            return Solution<I,\
    \ V, W, Q>(items, knapsack);\n        }\n    };\n}\n#line 5 \"verify/aizu_online_judge/dpl1/1C.test.cpp\"\
    \n\nusing namespace knapsack_problem;\n\n\nint main() {\n    int N, W; cin >>\
    \ N >> W;\n    vector<Item<int, int, int>> items(N);\n    for (int i = 0; i <\
    \ N; ++i) {\n        cin >> items[i].value >> items[i].weight;\n    }\n\n    cout\
    \ << Knapsack_Infinity<int, int, int, int>::solve_by_weight(items, W).total_value\
    \ << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/aizu_online_judge/dpl1/1C.test.cpp
layout: document
redirect_from:
- /verify/verify/aizu_online_judge/dpl1/1C.test.cpp
- /verify/verify/aizu_online_judge/dpl1/1C.test.cpp.html
