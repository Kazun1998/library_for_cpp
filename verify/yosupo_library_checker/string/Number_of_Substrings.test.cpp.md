...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/string/Number_of_Substrings.test.cpp\"\
    ...
    \ \"String/Longest_Common_Prefix.hpp\"\n\ntemplate<integral T>\nvector<int> Longest_Common_Prefix(const\
    \ vector<T> &A, const vector<int> &sa) {\n    int n = A.size();\n    if (n <=\
    ...
    \ Number_of_Continuous_Subsequence<char>(As);\n}\n#line 5 \"verify/yosupo_library_checker/string/Number_of_Substrings.test.cpp\"\
    \n\nint main() {\n    string S; cin >> S;\n    cout << Number_of_Substrings(S)\
    \ << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/string/Number_of_Substrings.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/string/Number_of_Substrings.test.cpp
- /verify/verify/yosupo_library_checker/string/Number_of_Substrings.test.cpp.html
