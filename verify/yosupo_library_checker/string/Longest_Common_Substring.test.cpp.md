...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/string/Longest_Common_Substring.test.cpp\"\
    ...
    \ S.end()), vector<char>(T.begin(), T.end()));\n}\n#line 5 \"verify/yosupo_library_checker/string/Longest_Common_Substring.test.cpp\"\
    \n\nint main() {\n    string S, T; cin >> S >> T;\n    auto [a, b, c, d] = Longest_Common_Substring(S,\
...
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/string/Longest_Common_Substring.test.cpp
- /verify/verify/yosupo_library_checker/string/Longest_Common_Substring.test.cpp.html
