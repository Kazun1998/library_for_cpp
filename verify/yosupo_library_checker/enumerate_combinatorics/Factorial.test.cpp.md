...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/enumerate_combinatorics/Factorial.test.cpp\"\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Modulo_Polynomial/Huge_Factorial.hpp\"\
    ...
    \ 0, m, 1, Q);\n\n    return Ys;\n}\n#line 5 \"Modulo_Polynomial/Huge_Factorial.hpp\"\
    ...
    \        points\n    );\n\n    mint res = 1;\n    for (int j = 0; j < N_sqrt;\
    \ ++j) res *= B[j];\n\n    for (ll k = N_sqrt * N_sqrt + 1; k <= N; ++k) res *=\
    \ k;\n\n    return res;\n}\n#line 5 \"verify/yosupo_library_checker/enumerate_combinatorics/Factorial.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2026-02-08 17:31:06+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/enumerate_combinatorics/Factorial.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/enumerate_combinatorics/Factorial.test.cpp
- /verify/verify/yosupo_library_checker/enumerate_combinatorics/Factorial.test.cpp.html
