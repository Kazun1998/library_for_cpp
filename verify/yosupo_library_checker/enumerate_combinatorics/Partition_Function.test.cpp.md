...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/enumerate_combinatorics/Partition_Function.test.cpp\"\
    ...
    \ bit_length(x)); }\n#line 2 \"Modulo_Polynomial/Partition_P.hpp\"\n\n#line 2\
    ...
    \ {\n        mint m = ((k & 1) == 0) ? 1 : -1;\n\n        int d1 = k * (3 * k\
    \ - 1) / 2, d2 = k * (3 * k + 1) / 2;\n        f[d1] += m;\n        if (d2 <=\
    \ N) { f[d2] += m; }\n    }\n\n    return calc.inverse(f);\n}\n#line 5 \"verify/yosupo_library_checker/enumerate_combinatorics/Partition_Function.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2025-10-05 21:11:04+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/enumerate_combinatorics/Partition_Function.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/enumerate_combinatorics/Partition_Function.test.cpp
- /verify/verify/yosupo_library_checker/enumerate_combinatorics/Partition_Function.test.cpp.html
