...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/graph/Minimum_Spanning_Tree_by_Kruskal.test.cpp\"\
    ...
    \ {\n        return message.c_str();\n    }\n};\n#line 2 \"Graph/Weighted_Graph/Kruskal.hpp\"\
    ...
    \ };\n    }\n}\n#line 5 \"verify/yosupo_library_checker/graph/Minimum_Spanning_Tree_by_Kruskal.test.cpp\"\
    \n\nusing namespace weighted_graph;\n\nint main() {\n    int N, M; cin >> N >>\
    \ M;\n    Weighted_Graph<ll> G(N);\n\n    for (int j = 0; j < M; j++) {\n    \
    \    int a, b; ll c;\n        scanf(\"%d%d%lld\", &a, &b, &c);\n        G.add_edge(a,\
    \ b, c);\n    }\n\n    Minimum_Spanning_Tree T = Kruskal(G);\n\n    cout << T.weight\
    \ << endl;\n    for (int k = 0; k < T.edges.size(); k++) {\n        cout << (k\
    \ ? \" \" : \"\") << T.edges[k]->id;\n    }\n\n    cout << \"\\n\";\n}\n"
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/minimum_spanning_tree\"\
    \n\n#include\"../../../template/template.hpp\"\n#include\"../../../Graph/Weighted_Graph/Kruskal.hpp\"\
    \n\nusing namespace weighted_graph;\n\nint main() {\n    int N, M; cin >> N >>\
    \ M;\n    Weighted_Graph<ll> G(N);\n\n    for (int j = 0; j < M; j++) {\n    \
    \    int a, b; ll c;\n        scanf(\"%d%d%lld\", &a, &b, &c);\n        G.add_edge(a,\
    \ b, c);\n    }\n\n    Minimum_Spanning_Tree T = Kruskal(G);\n\n    cout << T.weight\
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/graph/Minimum_Spanning_Tree_by_Kruskal.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/graph/Minimum_Spanning_Tree_by_Kruskal.test.cpp
- /verify/verify/yosupo_library_checker/graph/Minimum_Spanning_Tree_by_Kruskal.test.cpp.html
