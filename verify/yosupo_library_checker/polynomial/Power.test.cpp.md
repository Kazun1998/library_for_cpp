...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/polynomial/Power.test.cpp\"\
    ...
    \ - B * Q;\n    return {Q, R};\n}\n#line 2 \"Modulo_Polynomial/Power.hpp\"\n\n\
    ...
    \ G({1}, 1), one({1}, n);\n    for (; G.precision < n;) {\n        G.precision\
    \ *= 2;\n        G = G * (one - Log(G) + A);\n    }\n\n    return G;\n}\n#line\
    \ 4 \"Modulo_Polynomial/Power.hpp\"\n\n// A \u306E M \u4E57\u3092\u6C42\u3081\u308B\
    .\ntemplate<const ll Mod>\nFast_Polynominal_Series<Mod> pow(Fast_Polynominal_Series<Mod>\
    \ &A, ll M) {\n    using mint = modint<Mod>;\n    using FPS = Fast_Polynominal_Series<Mod>;\n\
    \n    // M = 0 \u306E\u3068\u304D\u306F, A^0 = 1 \u304C\u78BA\u5B9A\n    if (M\
    \ == 0) { return Fast_Polynominal_Series<Mod>({1}, A.precision); }\n\n    int\
    \ ord = A.order();\n\n    // A = 0 \u306E\u3068\u304D\u306F, M != 0 \u3088\u308A\
    , A^M = 0 \u304C\u78BA\u5B9A\n    if (ord == -1) { return Fast_Polynominal_Series<Mod>(A.precision);\
    \ }\n\n    // ord(A^M) = M ord(A) \u3067\u3042\u308B. M ord(A) > n \u306A\u3089\
    \u3070, A^M = 0 (mod X^n) \u306B\u306A\u308B.\n    if (ord > A.precision / M)\
    \ { return Fast_Polynominal_Series<Mod>(A.precision); }\n\n    mint content =\
    ...
    }\n#line 6 \"verify/yosupo_library_checker/polynomial/Power.test.cpp\"\n\nconst\
    \ ll Mod = 998244353;\nusing mint = modint<Mod>;\nusing FPS = Fast_Polynominal_Series<Mod>;\n\
    \nint main() {\n    int N; ll M ; cin >> N >> M;\n    vector<mint> a(N); cin >>\
    \ a;\n    FPS A(a);\n\n    FPS B = pow(A, M);\n    B.resize();\n\n    cout <<\
    \ B << endl;\n}\n"
  ...
  requiredBy: []
  timestamp: '2025-09-27 16:33:25+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/polynomial/Power.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/polynomial/Power.test.cpp
- /verify/verify/yosupo_library_checker/polynomial/Power.test.cpp.html
