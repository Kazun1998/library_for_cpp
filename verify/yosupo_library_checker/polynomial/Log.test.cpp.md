...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/polynomial/Log.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/polynomial/Log.test.cpp
- /verify/verify/yosupo_library_checker/polynomial/Log.test.cpp.html
