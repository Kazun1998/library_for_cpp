...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/polynomial/Convolution.test.cpp\"\
    ...
    \        }\n\n        return A[queue.back()];\n    }\n};\n#line 5 \"verify/yosupo_library_checker/polynomial/Convolution.test.cpp\"\
    \n\nconst ll Mod = 998244353;\nusing mint = modint<Mod>;\n\nint main() {\n   \
    \ int N, M; cin >> N >> M;\n    vector<mint> a(N), b(M);\n    for (int i = 0;\
    \ i < N; i++) {\n        int x; scanf(\"%d\", &x);\n        a[i] = mint(x);\n\
    \    }\n\n    for (int j = 0; j < M; j++) {\n        int y; scanf(\"%d\", &y);\n\
    \        b[j] = mint(y);\n    }\n\n    vector<mint> c = Numeric_Theory_Translation<mint>().convolution(a,\
    \ b);\n\n    cout << c << endl;\n}\n"
  ...
  requiredBy: []
  timestamp: '2025-10-12 01:19:35+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/polynomial/Convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/polynomial/Convolution.test.cpp
- /verify/verify/yosupo_library_checker/polynomial/Convolution.test.cpp.html
