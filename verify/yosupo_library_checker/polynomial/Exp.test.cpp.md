...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/polynomial/Exp.test.cpp\"\n\
    ...
    \ n);\n    for (; G.precision < n;) {\n        G.precision *= 2;\n        G =\
    \ G * (one - Log(G) + A);\n    }\n\n    return G;\n}\n#line 5 \"verify/yosupo_library_checker/polynomial/Exp.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/polynomial/Exp.test.cpp
- /verify/verify/yosupo_library_checker/polynomial/Exp.test.cpp.html
