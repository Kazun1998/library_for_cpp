...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/polynomial/Inverse.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/polynomial/Inverse.test.cpp
- /verify/verify/yosupo_library_checker/polynomial/Inverse.test.cpp.html
