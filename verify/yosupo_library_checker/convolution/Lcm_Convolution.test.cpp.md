...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/convolution/Lcm_Convolution.test.cpp\"\
    ...
    \ Lcm_Convolution operator+(const Lcm_Convolution &lhs, const Lcm_Convolution\
    ...
    \ &rhs) { \n            Lcm_Convolution temp(lhs);\n            temp *= rhs;\n\
    \            return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (a * rhs)\n        friend Lcm_Convolution operator*(const R &a, const Lcm_Convolution\
    \ &rhs) {\n            Lcm_Convolution temp(rhs);\n            temp *= a;\n  \
    \          return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (lhs * a)\n        friend Lcm_Convolution operator*(const Lcm_Convolution &lhs,\
    \ const R &a) {\n            Lcm_Convolution temp(lhs);\n            temp *= a;\n\
    ...
    \ + 1, true);\n\n            for (int p = 2; p <= n; p++) {\n                if\
    \ (!is_prime[p]) { continue; }\n\n                // \u30E1\u30D3\u30A6\u30B9\u9006\
    \u5909\u63DB: g[k*p] \u304B\u3089 g[k] \u3092\u5F15\u3044\u3066\u3044\u304F (backward)\n\
    \                for (size_t k = n / p; k > 0; k--) {\n                    is_prime[k\
    \ * p] = false;\n                    g[k * p] -= g[k];\n                }\n  \
    \          }\n        }\n    };\n}\n#line 6 \"verify/yosupo_library_checker/convolution/Lcm_Convolution.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/lcm_convolution\"\n\n#include\"\
    ...
    \nint main() {\n    int N; cin >> N;\n    convolution::Lcm_Convolution<mint> A(N\
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/convolution/Lcm_Convolution.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/convolution/Lcm_Convolution.test.cpp
- /verify/verify/yosupo_library_checker/convolution/Lcm_Convolution.test.cpp.html
