...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/number_theory/Stern-Brocot_Tree.test.cpp\"\
    ...
    \ s += d * q;\n        }\n\n        return {{p, q}, {r, s}};\n    }\n};\n#line\
    \ 5 \"verify/yosupo_library_checker/number_theory/Stern-Brocot_Tree.test.cpp\"\
    ...
    \    for (int i = 0; i < k; i++) {\n        scanf(\" %c %lld\", &path[i].first,\
    \ &path[i].second);\n    }\n\n    return Stern_Brocot_Tree::decode(path, 'L',\
    \ 'R');\n}\n\nStern_Brocot_Tree::Fraction lca() {\n    int a, b, c, d; scanf(\"\
    %d%d%d%d\", &a, &b, &c, &d);\n    return Stern_Brocot_Tree::lowest_common_ancestor(a,\
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/number_theory/Stern-Brocot_Tree.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/number_theory/Stern-Brocot_Tree.test.cpp
- /verify/verify/yosupo_library_checker/number_theory/Stern-Brocot_Tree.test.cpp.html
