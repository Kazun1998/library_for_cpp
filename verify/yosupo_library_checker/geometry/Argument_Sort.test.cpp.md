...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/geometry/Argument_Sort.test.cpp\"\
...
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/geometry/Argument_Sort.test.cpp
- /verify/verify/yosupo_library_checker/geometry/Argument_Sort.test.cpp.html
