...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/data_structure/Ordered_Set.test.cpp\"\
    ...
    \        return size() - less_count(key, !equal);\n    }\n};\n#line 5 \"verify/yosupo_library_checker/data_structure/Ordered_Set.test.cpp\"\
    \n\nint main() {\n    int N, Q; cin >> N >> Q;\n    Adelson_Velsky_and_Landis_Tree<int,\
    \ int> S;\n\n    for (int i = 0; i < N; i++) {\n        int a; cin >> a;\n   \
    \     S.insert(a);\n    }\n\n    for (int q = 0; q < Q; q++) {\n        int t,\
    \ x; scanf(\"%d%d\", &t, &x);\n        if (t == 0) {\n            S.insert(x);\n\
    \        } else if (t == 1) {\n            S.discard(x);\n        } else if (t\
  ...
  requiredBy: []
  timestamp: '2025-11-16 14:39:19+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/data_structure/Ordered_Set.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/data_structure/Ordered_Set.test.cpp
- /verify/verify/yosupo_library_checker/data_structure/Ordered_Set.test.cpp.html
