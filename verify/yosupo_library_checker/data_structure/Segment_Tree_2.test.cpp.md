...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/data_structure/Segment_Tree_2.test.cpp\"\
    ...
    \ vector<M> &vec, Op op, const M unit):\n        Segment_Tree(vec.size(), op,\
    ...
    \ M) -> Segment_Tree<M, Op>;\n#line 2 \"Segment_Tree/preset/Range_Min.hpp\"\n\n\
    #line 4 \"Segment_Tree/preset/Range_Min.hpp\"\n\ntemplate<typename T>\nclass Range_Min_Segment_Tree\
    \ : public Segment_Tree<T, T(*)(T, T)> {\n    static T op(T x, T y) { return x\
    \ < y ? x : y; }\n\n    public:\n    Range_Min_Segment_Tree(int n, T unit) : Segment_Tree<T,\
    \ T(*)(T, T)>(n, op, unit) {}\n\n    Range_Min_Segment_Tree(const vector<T> &vec,\
    \ T unit) : Segment_Tree<T, T(*)(T, T)>(vec, op, unit) {}\n\n    void update(int\
    \ k, T x) { Segment_Tree<T, T(*)(T, T)>::update(k, x); }\n\n    // \u7B2C k \u8981\
    \u7D20\u3092\u53D6\u5F97\u3059\u308B\n    T get(int k) { return Segment_Tree<T,\
    \ T(*)(T, T)>::get(k); }\n\n    T operator[](int k) { return get(k); }\n\n   \
    \ // \u533A\u9593 [l, r] \u306E\u6700\u5C0F\u5024\u3092\u6C42\u3081\u308B\n  \
    \  T min(int l, int r) { return this->product(l, r); }\n};\n#line 6 \"verify/yosupo_library_checker/data_structure/Segment_Tree_2.test.cpp\"\
    \n\nint main(){\n    int N, Q; cin >> N >> Q;\n    vector<int> a(N);\n    for\
    \ (int i = 0; i < N; i++) { cin >> a[i]; }\n\n    Range_Min_Segment_Tree<int>\
    \ S(a, numeric_limits<int>::max());\n\n    for (; Q; Q--) {\n        int l, r;\n\
    \        scanf(\"%d%d\", &l, &r);\n        cout << S.min(l, r - 1) << \"\\n\"\
    ;\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/data_structure/Segment_Tree_2.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/data_structure/Segment_Tree_2.test.cpp
- /verify/verify/yosupo_library_checker/data_structure/Segment_Tree_2.test.cpp.html
