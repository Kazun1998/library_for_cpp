...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/data_structure/Ordered_Set_2.test.cpp\"\
    ...
    \ t.end(); }\n};\n#line 5 \"verify/yosupo_library_checker/data_structure/Ordered_Set_2.test.cpp\"\
    \n\nint main() {\n    int N, Q; cin >> N >> Q;\n    Ordered_Set<int> S;\n\n  \
    \  for (int i = 0; i < N; i++) {\n        int a; cin >> a;\n        S.insert(a);\n\
    \    }\n\n    for (int q = 0; q < Q; q++) {\n        int t, x; scanf(\"%d%d\"\
    , &t, &x);\n        if (t == 0) {\n            S.insert(x);\n        } else if\
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/data_structure/Ordered_Set_2.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/data_structure/Ordered_Set_2.test.cpp
- /verify/verify/yosupo_library_checker/data_structure/Ordered_Set_2.test.cpp.html
