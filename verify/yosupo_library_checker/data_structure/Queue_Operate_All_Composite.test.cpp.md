...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/data_structure/Queue_Operate_All_Composite.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2026-02-14 20:13:22+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/data_structure/Queue_Operate_All_Composite.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/data_structure/Queue_Operate_All_Composite.test.cpp
- /verify/verify/yosupo_library_checker/data_structure/Queue_Operate_All_Composite.test.cpp.html
