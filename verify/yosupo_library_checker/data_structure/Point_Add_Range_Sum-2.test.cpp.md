...
data:
  ...
  bundledCode: "#line 1 \"verify/yosupo_library_checker/data_structure/Point_Add_Range_Sum-2.test.cpp\"\
    ...
    \ lo)])); }\n        return res;\n    }\n};\n#line 2 \"Interval_Query/Sqrt_Decomposer.hpp\"\
    ...
    \ {\n            State s = 0;\n            for (const State &c: children) { s\
    \ += c; }\n            return s;\n        },\n        [](State &s, int, const\
    \ ll &before, const ll &after) {\n            s += after - before;\n        }\n\
    \    );\n\n    vector<ll> ans;\n    for (int q = 0; q < Q; ++q) {\n        int\
    \ t; cin >> t;\n        if (t == 0) {\n            int p; ll x; cin >> p >> x;\n\
  ...
  verifiedWith: []
documentation_of: verify/yosupo_library_checker/data_structure/Point_Add_Range_Sum-2.test.cpp
layout: document
redirect_from:
- /verify/verify/yosupo_library_checker/data_structure/Point_Add_Range_Sum-2.test.cpp
- /verify/verify/yosupo_library_checker/data_structure/Point_Add_Range_Sum-2.test.cpp.html
