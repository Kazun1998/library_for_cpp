...
data:
  ...
  bundledCode: "#line 1 \"verify/yukicoder/187.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/187\"\
    ...
    \ * x.n, R);\n\n            return res;\n        }\n\n        ll res = 0;\n  \
    \      for (int i = n - 1; i >=0 ; --i) {\n            res = safe_mod(X[i].n *\
    \ res + s[i], R);\n        }\n\n        return res;\n    }\n}\n#line 5 \"verify/yukicoder/187.test.cpp\"\
    \n\nusing namespace modulo;\nll solve() {\n    int n; cin >> n;\n    vector<Modulo>\
    \ modulos(n);\n    for (int i = 0; i < n; ++i) {\n        ll x, y; cin >> x >>\
    \ y;\n        modulos[i] = Modulo(x, y);\n    }\n\n    return First_Garner(modulos,\
    \ intpow(10, 9) + 7, true).value_or(-1);\n}\n\nint main() {\n    cout << solve()\
    \ << endl;\n}\n"
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/187.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/187.test.cpp
- /verify/verify/yukicoder/187.test.cpp.html
