...
data:
  ...
  bundledCode: "#line 2 \"Imos/Cyclic_Imos_1.hpp\"\n\n// https://github.com/Kazun1998/library_for_cpp/blob/main/Imos/Cyclic_Imos_1.hpp\n\
    ...
    \    }\n};\n#line 6 \"Imos/Cyclic_Imos_1.hpp\"\n\ntemplate <typename T>\nclass\
    \ Cyclic_Imos_1 {\n    private:\n    std::vector<T> lazy;\n    int n;\n\n    inline\
    \ int norm(int t) const { return ((t % n) + n) % n; }\n\n    public:\n    Cyclic_Imos_1(const\
    \ int n) : n(n), lazy(n, 0) {}\n\n    /// @brief \u5468\u9577 n \u306E\u5186\u74B0\
    \u4E0A\u3067, l \u304B\u3089 r \u307E\u3067 (l \u304B\u3089\u6642\u8A08\u56DE\u308A\
    \u306B r \u307E\u3067) \u306E\u5404\u8981\u7D20\u306B x \u3092\u52A0\u7B97\u3059\
    \u308B\n    /// @details l <= r (mod \u3067\u6B63\u898F\u5316\u3057\u305F\u4E0A\
    \u3067) \u306E\u3068\u304D\u306F\u901A\u5E38\u306E\u9589\u533A\u9593 [l, r] \u3078\
    \u306E\u52A0\u7B97, l > r \u306E\u3068\u304D\u306F [l, n - 1] \u3068 [0, r] \u3078\
    \u306E\u52A0\u7B97\u3092\u610F\u5473\u3059\u308B.\n    /// @param l \u59CB\u70B9\
    \n    /// @param r \u7D42\u70B9\n    /// @param x \u52A0\u7B97\u5024\n    void\
    ...
    \     if (r + 1 < n) lazy[r + 1] -= x;\n        } else {\n            lazy[0]\
    \ += x;\n            lazy[r + 1] -= x;\n            lazy[l] += x;\n        }\n\
    \    }\n\n    /// @brief \u5468\u9577 n \u306E\u5186\u74B0\u4E0A\u3067, l \u304B\
    \u3089 r \u307E\u3067 (l \u304B\u3089\u6642\u8A08\u56DE\u308A\u306B r \u307E\u3067\
    ) \u306E\u5404\u8981\u7D20\u306B 1 \u3092\u52A0\u7B97\u3059\u308B\n    /// @param\
    ...
    \ @brief \u5468\u9577 n \u306E\u5186\u74B0\u4E0A\u3067, l, l + 1, ..., l + (k\
    \ - 1) \u306E\u5404\u8981\u7D20\u306B x \u3092\u52A0\u7B97\u3059\u308B\n    ///\
    \ @param l \u59CB\u70B9\n    /// @param k \u52A0\u7B97\u3059\u308B\u8981\u7D20\
    \u6570\n    /// @param x \u52A0\u7B97\u5024\n    void add_forward(const int l,\
