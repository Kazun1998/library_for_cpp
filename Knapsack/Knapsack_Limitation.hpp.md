...
data:
  ...
  attributes:
    document_title: "\u500B\u6570\u5236\u9650\u4ED8\u304D\u30CA\u30C3\u30D7\u30B5\u30C3\
      \u30AF\u554F\u984C\u3092\u30010-1\u30CA\u30C3\u30D7\u30B5\u30C3\u30AF\u554F\u984C\
      \u306B\u5909\u63DB\u3057\u3066\u89E3\u304F"
    links: []
  bundledCode: "#line 2 \"Knapsack/Knapsack_Limitation.hpp\"\n\n#line 2 \"Knapsack/Base.hpp\"\
    ...
    \n\nnamespace knapsack_problem {\n    template<copyable I, integral V, integral\
    \ W, integral Q>\n    class Knapsack_01 {\n        using ItemList = vector<Item<I,\
    \ V, W>>;\n\n        public:\n        /**\n         * @brief \u5404\u30A2\u30A4\
    \u30C6\u30E0\u306E\u91CD\u3055\u304C\u8EFD\u3044\u5834\u5408\u306E 0-1 \u30CA\u30C3\
    \u30D7\u30B5\u30C3\u30AF\u554F\u984C\u3092\u52D5\u7684\u8A08\u753B\u6CD5\u3067\
    \u89E3\u304F\n         * \n         * @param items \u8A70\u3081\u8FBC\u3080\u30A2\
    ...
    \u30D7\u30B5\u30C3\u30AF\u306E\u5BB9\u91CF\n         * @return Solution<I, V,\
    \ W, Q> \u6700\u9069\u89E3\u306E\u60C5\u5831\n         */\n        static Solution<I,\
    \ V, W, Q> solve_by_weight(const vector<Item<I, V, W>> &items, const W capacity)\
    \ {\n            int n = items.size();\n            vector<vector<V>> dp(n + 1,\
    \ vector<V>(capacity + 1, 0));\n\n            for (int i = 1; i <= n; i++) {\n\
    \                const auto &item = items[i - 1];\n\n                for (W w\
    \ = 0; w <= capacity; ++w) {\n                    dp[i][w] = dp[i - 1][w];\n \
    \                   if (w >= item.weight) {\n                        dp[i][w]\
    \ = max(dp[i][w], dp[i - 1][w - item.weight] + item.value);\n                \
    \    }\n                }\n            }\n\n            W current_weight = static_cast<W>(argmax(dp[n]));\n\
    \            vector<Q> knapsack(n, 0);\n\n            for (int i = n; i >= 1;\
    \ --i) {\n                const auto &item = items[i - 1];\n\n               \
    \ if (item.weight <= current_weight && dp[i][current_weight] == dp[i - 1][current_weight\
    ...
    \u5C0F\u3055\u3044\u5834\u5408\u306E 0-1 \u30CA\u30C3\u30D7\u30B5\u30C3\u30AF\u554F\
    \u984C\u3092\u52D5\u7684\u8A08\u753B\u6CD5\u3067\u89E3\u304F\n         * \n  \
    \       * @param items \u8A70\u3081\u8FBC\u3080\u30A2\u30A4\u30C6\u30E0\u306E\u30EA\
    \u30B9\u30C8\n         * @param capacity \u30CA\u30C3\u30D7\u30B5\u30C3\u30AF\u306E\
    \u5BB9\u91CF\n         * @return Solution<I, V, W, Q> \u6700\u9069\u89E3\u306E\
    \u60C5\u5831\n         */\n        static Solution<I, V, W, Q> solve_by_value(const\
    ...
    \ knapsack_problem {\n    template<copyable I, integral V, integral W, integral\
    ...
    \ V, W>> &items, const vector<Q> &limit, const W capacity) {\n            const\
    \ int n = items.size();\n\n            vector<Item<pair<I, Q>, V, W>> reduced_items;\n\
    \            for (int i = 0; i < n; ++i) {\n                const Item<I, V, W>\
    \ item = items[i];\n\n                int m = limit[i];\n                for (Q\
    \ k = 1; m > 0; m -= k, k = min(2 * k, m)) {\n                    reduced_items.emplace_back(Item<pair<I,\
    \ Q>, V, W>(make_pair(i, k), item.value * k, item.weight * k));\n            \
    \    }\n            }\n\n            Solution<pair<I, Q>, V, W, Q> reduced_result\
    \ = Knapsack_01<pair<I, Q>, V, W, Q>::solve_by_weight(reduced_items, capacity);\n\
    \n            vector<Q> knapsack(n, 0);\n            for (int j = 0; j < reduced_items.size();\
  ...
  requiredBy: []
  timestamp: '2026-03-29 20:23:33+09:00'
