...
data:
  ...
  bundledCode: "#line 2 \"Geometry/triangle_center/Centroid.hpp\"\n\n#line 2 \"Geometry/object/Triangle.hpp\"\
    ...
    \ X / 2 : -X / 2;\n    }\n}\n#line 4 \"Geometry/triangle_center/Centroid.hpp\"\
    \n\nnamespace geometry {\n    template<typename R>\n    Point<R> Centroid(const\
    \ Triangle<R> &T) { return T.balance(1, 1, 1); }\n}\n"
...
layout: document
redirect_from:
- /library/Geometry/triangle_center/Centroid.hpp
- /library/Geometry/triangle_center/Centroid.hpp.html
