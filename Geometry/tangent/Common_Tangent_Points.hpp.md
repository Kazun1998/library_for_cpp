...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/tangent/Common_Tangent_Points.hpp\"\n\n#line 2\
    ...
    \ r, d);\n        if (q == 1) { return 2; }\n        else if (q == 0) { return\
    \ 1; }\n\n        return 0;\n    }\n}\n#line 2 \"Geometry/tangent/Tangent_Point_from_Point_to_Circle.hpp\"\
    ...
    \ s));\n    }\n}\n#line 7 \"Geometry/tangent/Common_Tangent_Points.hpp\"\n\nnamespace\
    \ geometry {\n    // \u5171\u901A\u63A5\u7DDA\u306E\u5186 C \u306B\u304A\u3051\
...
documentation_of: Geometry/tangent/Common_Tangent_Points.hpp
layout: document
redirect_from:
- /library/Geometry/tangent/Common_Tangent_Points.hpp
- /library/Geometry/tangent/Common_Tangent_Points.hpp.html
