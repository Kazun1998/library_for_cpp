...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Circumcenter.hpp\"\n\n#line 2 \"Geometry/Perpendicular_Bisector.hpp\"\
    ...
    \ ? Inclusion::ON : Inclusion::OUT;\n        }\n    };\n}\n#line 2 \"Geometry/Division_Point.hpp\"\
    \n\n#line 4 \"Geometry/Division_Point.hpp\"\n\nnamespace geometry {\n    // \u7DDA\
    \u5206 AB \u3092 p:q \u306B\u5185\u5206\u3059\u308B\u70B9\u3092\u6C42\u3081\u308B\
    .\n    template<typename R>\n    Point<R> Internal_Division(const Point<R> &A,\
    \ const Point<R> &B, const R &p, const R &q) {\n        return (q * A + p * B)\
    \ / (p + q);\n    }\n\n    // \u7DDA\u5206 AB \u306E\u4E2D\u70B9\n    template<typename\
    \ R>\n    Point<R> MidPoint(const Point<R> &A, const Point<R> &B) { return (A\
    \ + B) / 2; }\n\n    // \u7DDA\u5206 AB \u3092 p:q \u306B\u5916\u5206\u3059\u308B\
    \u70B9\u3092\u6C42\u3081\u308B.\n    template<typename R>\n    Point<R> External_Division(const\
    \ Point<R> &A, const Point<R> &B, const R &p, const R &q) {\n        return (-q\
    \ * A + p * B) / (p - q);\n    }\n}\n#line 5 \"Geometry/Perpendicular_Bisector.hpp\"\
    \n\nnamespace geometry {\n    // 2 \u70B9 A, B \u306B\u95A2\u3059\u308B\u5782\u76F4\
    \u4E8C\u7B49\u5206\u7DDA\u3092\u6C42\u3081\u308B.\n    template<typename R>\n\
    \    Line<R> Perpendicular_Bisector(const Point<R> &A, const Point<R> &B) {\n\
    \        auto M = MidPoint(A, B);\n        auto d = B - A;\n        Point<R> n(-d.y,\
    \ d.x);\n\n        return Line<R>(M, M + n);\n    }\n}\n#line 2 \"Geometry/Intersection_Line_and_Line.hpp\"\
    \n\n#line 2 \"Geometry/Parallel_Orthogonal_Line_Line.hpp\"\n\n#line 4 \"Geometry/Parallel_Orthogonal_Line_Line.hpp\"\
    \n\nnamespace geometry {\n    template<typename R>\n    Direction_Relation Parallel_Orthogonal\
    \ (const Line<R> &l, const Line<R> &m) {\n        auto u = l.vectorize(), v =\
    \ m.vectorize();\n        if (sign(dot(u, v)) == 0) { return Direction_Relation::ORTHOGONAL;\
    \ }\n        if (sign(cross(u, v)) == 0) { return Direction_Relation::PARALLEL;\
    \ }\n        return Direction_Relation::CROSS;\n    }\n};\n#line 5 \"Geometry/Intersection_Line_and_Line.hpp\"\
    ...
    \ X / 2 : -X / 2;\n    }\n}\n#line 6 \"Geometry/Circumcenter.hpp\"\n\nnamespace\
    \ geometry {\n    template<typename R>\n    Point<R> Circumcenter(const Triangle<R>\
    \ &T) { \n        Line<R> l = Perpendicular_Bisector(T.A, T.B), m = Perpendicular_Bisector(T.A,\
    \ T.C);\n        return Intersection(l, m);\n    }\n}\n"
  code: "#pragma once\n\n#include\"Perpendicular_Bisector.hpp\"\n#include\"Intersection_Line_and_Line.hpp\"\
    \n#include\"Triangle.hpp\"\n\nnamespace geometry {\n    template<typename R>\n\
    \    Point<R> Circumcenter(const Triangle<R> &T) { \n        Line<R> l = Perpendicular_Bisector(T.A,\
    \ T.B), m = Perpendicular_Bisector(T.A, T.C);\n        return Intersection(l,\
    \ m);\n    }\n}\n"
  dependsOn:
...
documentation_of: Geometry/Circumcenter.hpp
layout: document
redirect_from:
- /library/Geometry/Circumcenter.hpp
- /library/Geometry/Circumcenter.hpp.html
