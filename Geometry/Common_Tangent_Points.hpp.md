...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Common_Tangent_Points.hpp\"\n\n#line 2 \"Geometry/Circle.hpp\"\
    ...
    \ ? Inclusion::ON : Inclusion::OUT;\n        }\n    };\n}\n#line 2 \"Geometry/Relationship_Circle_and_Circle.hpp\"\
    \n\n#line 4 \"Geometry/Relationship_Circle_and_Circle.hpp\"\n\nnamespace geometry\
    \ {\n    template<typename R>\n    int Relationship(const Circle<R> &C, const\
    \ Circle<R> &D) {\n        unless (C.radius <= D.radius) { return Relationship(D,\
    \ C); }\n\n        auto d = norm(C.center - D.center);\n        auto r = C.radius,\
    \ s = D.radius;\n\n        int p = compare(r + s, d);\n        if (p == 1) { return\
    \ 4; }\n        else if (p == 0) { return 3; }\n\n        int q = compare(s -\
    \ r, d);\n        if (q == 1) { return 2; }\n        else if (q == 0) { return\
    \ 1; }\n\n        return 0;\n    }\n}\n#line 2 \"Geometry/Tangent_Point_from_Point_to_Circle.hpp\"\
    ...
    \ s));\n    }\n}\n#line 7 \"Geometry/Common_Tangent_Points.hpp\"\n\nnamespace\
    \ geometry {\n    // \u5171\u901A\u63A5\u7DDA\u306E\u5186 C \u306B\u304A\u3051\
    \u308B\u63A5\u70B9\n    template<typename R>\n    vector<Point<R>> Common_Tangent_Points(const\
    ...
    \  }\n\n        if (k >= 3){\n            Real a = r * (r + s) / d, b = sqrt(r\
    \ * r - a * a);\n            tangents.emplace_back(C.center + op * Point(a, b));\n\
    \            if (k > 3) { tangents.emplace_back(C.center + op * Point(a,-b));\
    \ }\n        }\n\n        return tangents;\n    }\n}\n"
  code: "#pragma once\n\n#include\"Circle.hpp\"\n#include\"Line.hpp\"\n#include\"\
    Relationship_Circle_and_Circle.hpp\"\n#include\"Tangent_Point_from_Point_to_Circle.hpp\"\
    \n\nnamespace geometry {\n    // \u5171\u901A\u63A5\u7DDA\u306E\u5186 C \u306B\
    \u304A\u3051\u308B\u63A5\u70B9\n    template<typename R>\n    vector<Point<R>>\
    \ Common_Tangent_Points(const Circle<R> &C, const Circle<R> &D){\n        int\
    \ k = Relationship(C, D);\n        vector<Point<R>> tangents;\n\n        R r =\
    \ C.radius, s = D.radius;\n        Point<R> v = D.center - C.center;\n       \
    \ Real d = v.norm(), theta = arg(v);\n        Point<Real> op = Point(cos(theta),\
    \ sin(theta));\n\n        if (k >= 1){\n            Real a = r * (r - s) / d,\
    \ b = sqrt(r * r - a * a);\n            tangents.emplace_back(C.center + op *\
    \ Point(a, b));\n            if (k > 1) { tangents.emplace_back(C.center + op\
    \ * Point(a, -b)); }\n        }\n\n        if (k >= 3){\n            Real a =\
    \ r * (r + s) / d, b = sqrt(r * r - a * a);\n            tangents.emplace_back(C.center\
    \ + op * Point(a, b));\n            if (k > 3) { tangents.emplace_back(C.center\
    \ + op * Point(a,-b)); }\n        }\n\n        return tangents;\n    }\n}\n"
  dependsOn:
  - Geometry/Circle.hpp
  - Geometry/Point.hpp
  ...
  requiredBy: []
  timestamp: '2025-09-21 12:26:44+09:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - verify/aizu_online_judge/cgl/7G.test.cpp
documentation_of: Geometry/Common_Tangent_Points.hpp
layout: document
redirect_from:
- /library/Geometry/Common_Tangent_Points.hpp
- /library/Geometry/Common_Tangent_Points.hpp.html
