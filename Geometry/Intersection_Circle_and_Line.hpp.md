...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Intersection_Circle_and_Line.hpp\"\n\n#line 2 \"\
    ...
    \ pi * C.radius * C.radius; }\n}\n#line 2 \"Geometry/Distance_Line_and_Point.hpp\"\
    \n\n#line 4 \"Geometry/Distance_Line_and_Point.hpp\"\n\nnamespace geometry {\n\
    \    template<typename R>\n    R Distance(const Line<R> &l, const Point<R> P)\
    \ {\n        R S = abs<R>(cross(l.vectorize(), P - l.A));\n        return S /\
    \ norm(l.vectorize());\n    }\n}\n#line 7 \"Geometry/Intersection_Circle_and_Line.hpp\"\
...
documentation_of: Geometry/Intersection_Circle_and_Line.hpp
layout: document
redirect_from:
- /library/Geometry/Intersection_Circle_and_Line.hpp
- /library/Geometry/Intersection_Circle_and_Line.hpp.html
