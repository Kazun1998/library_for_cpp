...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Intersection_Circle_and_Circle.hpp\"\n\n#line 2\
  ...
  code: "#pragma once\n\n#include\"Circle.hpp\"\n\nnamespace geometry {\n    template<typename\
    \ R>\n    vector<Point<Real>> Intersection(const Circle<R> &C, const Circle<R>\
    \ &D) {\n        Point<R> v = D.center - C.center;\n        Point<R> e = v.normalize();\n\
    \        Point<R> f = e.normal();\n\n        R d= v.norm(), r = C.radius, s =\
    \ D.radius;\n        R x = (d * d + r * r - s * s) / (2 * d), y = sqrt(r * r -\
...
documentation_of: Geometry/Intersection_Circle_and_Circle.hpp
layout: document
redirect_from:
- /library/Geometry/Intersection_Circle_and_Circle.hpp
- /library/Geometry/Intersection_Circle_and_Circle.hpp.html
