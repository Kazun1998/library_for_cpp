...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Projection_Point_Point.hpp\"\n\n#line 2 \"Geometry/Line.hpp\"\
    ...
    \ ? Inclusion::ON : Inclusion::OUT;\n        }\n    };\n}\n#line 4 \"Geometry/Projection_Point_Point.hpp\"\
    \n\nnamespace geometry {\n    // \u70B9 P \u304C\u70B9 X \u306B\u95A2\u3057\u3066\
    \u5BFE\u79F0\u79FB\u52D5\u3057\u305F\u5F8C\u306E\u70B9\u3092\u6C42\u3081\u308B\
    .\n    template<typename R>\n    Point<R> Projection(const Point<R> &P, const\
    \ Point<R> &A) {\n        return 2 * A - P;\n    }\n}\n"
  code: "#pragma once\n\n#include\"Line.hpp\"\n\nnamespace geometry {\n    // \u70B9\
    \ P \u304C\u70B9 X \u306B\u95A2\u3057\u3066\u5BFE\u79F0\u79FB\u52D5\u3057\u305F\
    \u5F8C\u306E\u70B9\u3092\u6C42\u3081\u308B.\n    template<typename R>\n    Point<R>\
    \ Projection(const Point<R> &P, const Point<R> &A) {\n        return 2 * A - P;\n\
    \    }\n}\n"
  dependsOn:
  - Geometry/Line.hpp
  - Geometry/Point.hpp
  ...
  verifiedWith: []
documentation_of: Geometry/Projection_Point_Point.hpp
layout: document
redirect_from:
- /library/Geometry/Projection_Point_Point.hpp
- /library/Geometry/Projection_Point_Point.hpp.html
