...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Geometry/Parallel_Orthogonal_Line_Line.hpp\"\n\n#line 2\
  ...
  code: "#pragma once\n\n#include\"Line.hpp\"\n\nnamespace geometry {\n    template<typename\
    \ R>\n    Direction_Relation Parallel_Orthogonal (const Line<R> &l, const Line<R>\
    \ &m) {\n        auto u = l.vectorize(), v = m.vectorize();\n        if (sign(dot(u,\
    \ v)) == 0) { return Direction_Relation::ORTHOGONAL; }\n        if (sign(cross(u,\
    \ v)) == 0) { return Direction_Relation::PARALLEL; }\n        return Direction_Relation::CROSS;\n\
    \    }\n};\n"
  dependsOn:
  - Geometry/Line.hpp
  - Geometry/Point.hpp
...
documentation_of: Geometry/Parallel_Orthogonal_Line_Line.hpp
layout: document
redirect_from:
- /library/Geometry/Parallel_Orthogonal_Line_Line.hpp
- /library/Geometry/Parallel_Orthogonal_Line_Line.hpp.html
