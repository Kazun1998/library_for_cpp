...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Convolution/Double_Add_Convolution.hpp\"\n\n#line 2 \"template/template.hpp\"\
    \n\nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n#include\
    \ <algorithm>\n#include <array>\n#include <bitset>\n#include <cassert>\n#include\
    \ <cctype>\n#include <cfenv>\n#include <cfloat>\n#include <chrono>\n#include <cinttypes>\n\
    #include <climits>\n#include <cmath>\n#include <complex>\n#include <concepts>\n\
    ...
    \u307F\u3092 FFT \u3067\u8A08\u7B97\u3059\u308B.\n    // \u8AA4\u5DEE\u3092\u542B\
    \u3080\u305F\u3081, \u53B3\u5BC6\u306A\u6574\u6570\u7573\u307F\u8FBC\u307F\u306B\
    \u306F Numeric_Theory_Translation \u7B49\u3092\u4F7F\u3046\u3053\u3068.\n    class\
    ...
    \u90E8\u3067 double \u3092\u7528\u3044\u3066\u8A08\u7B97\u3059\u308B (\u8AA4\u5DEE\
    \u306B\u3088\u308A\u53B3\u5BC6\u6027\u306F\u4FDD\u8A3C\u3055\u308C\u306A\u3044\
    ).\n        static vector<ll> convolution(const vector<ll> &A, const vector<ll>\
    \ &B) {\n            if (A.empty() || B.empty()) { return {}; }\n\n          \
    \  int L = A.size() + B.size() - 1;\n\n            int N = 1;\n            while\
    \ (N < L) { N <<= 1; }\n\n            vector<Complex> FA(N), FB(N);\n        \
    \    for (size_t i = 0; i < A.size(); i++) { FA[i] = A[i]; }\n            for\
    \ (size_t i = 0; i < B.size(); i++) { FB[i] = B[i]; }\n\n            fft(FA, false);\n\
...
documentation_of: Convolution/Double_Add_Convolution.hpp
layout: document
redirect_from:
- /library/Convolution/Double_Add_Convolution.hpp
- /library/Convolution/Double_Add_Convolution.hpp.html
