...
data:
  ...
  bundledCode: "#line 2 \"Convolution/Max_Convolution.hpp\"\n\n#line 2 \"Convolution/Semilattice_Convolution_Base.hpp\"\
    ...
    \ }\n}\n#line 4 \"Convolution/Max_Convolution.hpp\"\n\nnamespace convolution {\n\
    \    template<typename R>\n    class Max_Convolution: public Semilattice_Convolution_Base<R>\
    \ {\n        using Base = Convolution_Base<R>;\n        using ImplBase = Semilattice_Convolution_Base<R>;\n\
    \        using ImplBase::ImplBase;\n\n        // \u52A0\u6CD5 (+)\n        friend\
    \ Max_Convolution operator+(const Max_Convolution &lhs, const Max_Convolution\
    ...
    \ &rhs) { \n            Max_Convolution temp(lhs);\n            temp *= rhs;\n\
    \            return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (a * rhs)\n        friend Max_Convolution operator*(const R &a, const Max_Convolution\
    \ &rhs) {\n            Max_Convolution temp(rhs);\n            temp *= a;\n  \
    \          return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (lhs * a)\n        friend Max_Convolution operator*(const Max_Convolution &lhs,\
    \ const R &a) {\n            Max_Convolution temp(lhs);\n            temp *= a;\n\
  ...
  verifiedWith: []
documentation_of: Convolution/Max_Convolution.hpp
layout: document
redirect_from:
- /library/Convolution/Max_Convolution.hpp
- /library/Convolution/Max_Convolution.hpp.html
