...
data:
  ...
  bundledCode: "#line 2 \"Convolution/Min_Convolution.hpp\"\n\n#line 2 \"Convolution/Semilattice_Convolution_Base.hpp\"\
    ...
    \ }\n}\n#line 4 \"Convolution/Min_Convolution.hpp\"\n\nnamespace convolution {\n\
    \    template<typename R>\n    class Min_Convolution: public Semilattice_Convolution_Base<R>\
    \ {\n        using Base = Convolution_Base<R>;\n        using ImplBase = Semilattice_Convolution_Base<R>;\n\
    \        using ImplBase::ImplBase;\n\n        // \u52A0\u6CD5 (+)\n        friend\
    \ Min_Convolution operator+(const Min_Convolution &lhs, const Min_Convolution\
    ...
    \ &rhs) { \n            Min_Convolution temp(lhs);\n            temp *= rhs;\n\
    \            return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (a * rhs)\n        friend Min_Convolution operator*(const R &a, const Min_Convolution\
    \ &rhs) {\n            Min_Convolution temp(rhs);\n            temp *= a;\n  \
    \          return temp;\n        }\n\n        // \u30B9\u30AB\u30E9\u30FC\u500D\
    \ (lhs * a)\n        friend Min_Convolution operator*(const Min_Convolution &lhs,\
    \ const R &a) {\n            Min_Convolution temp(lhs);\n            temp *= a;\n\
    \            return temp;\n        }\n\n        void zeta_transform(std::vector<R>\
    \ &f) const override {\n            if (f.empty()) return;\n            // \u5F8C\
    \u308D\u304B\u3089\u306E\u7D2F\u7A4D\u548C: F[i] = sum_{j >= i} f[j]\n       \
    \     for (size_t i = f.size() - 1; i > 0; i--) {\n                f[i - 1] +=\
    \ f[i];\n            }\n        }\n\n        void mobius_transform(std::vector<R>\
    \ &g) const override {\n            if (g.empty()) return;\n            // \u5F8C\
    \u308D\u304B\u3089\u306E\u5DEE\u5206: g[i] = G[i] - G[i+1]\n            for (size_t\
    \ i = 0; i + 1 < g.size(); i++) {\n                g[i] -= g[i + 1];\n       \
    \     }\n        }\n    };\n}\n"
  ...
  verifiedWith: []
documentation_of: Convolution/Min_Convolution.hpp
layout: document
redirect_from:
- /library/Convolution/Min_Convolution.hpp
- /library/Convolution/Min_Convolution.hpp.html
