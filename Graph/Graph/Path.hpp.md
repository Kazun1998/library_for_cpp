...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"Graph/Graph/Path.hpp\"\n\n#line 2 \"Graph/Graph/Graph.hpp\"\
    ...
    \n\nnamespace graph {\n    struct Path {\n        vector<int> vertices;\n    \
    \    vector<Edge> edges;\n\n        Path(const int first, const vector<Edge> &path):\
...
documentation_of: Graph/Graph/Path.hpp
layout: document
redirect_from:
- /library/Graph/Graph/Path.hpp
- /library/Graph/Graph/Path.hpp.html
