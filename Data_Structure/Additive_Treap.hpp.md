...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"Data_Structure/Additive_Treap.hpp\"\n\n#line 2 \"template/template.hpp\"\
    \n\nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n#include\
    \ <algorithm>\n#include <array>\n#include <bitset>\n#include <cassert>\n#include\
    \ <cctype>\n#include <cfenv>\n#include <cfloat>\n#include <chrono>\n#include <cinttypes>\n\
    #include <climits>\n#include <cmath>\n#include <complex>\n#include <concepts>\n\
    ...
    \    }\n};\n#line 4 \"Data_Structure/Additive_Treap.hpp\"\n\ntemplate<typename\
    ...
    \        return node;\n    }\n\n    static void split_upper(Node* tree, T key,\
    \ Node*& less_eq, Node*& more) {\n        if (!tree) { less_eq = more = nullptr;\
    \ return; }\n        if (!(key < tree->key)) { // tree->key <= key\n         \
    \   split_upper(tree->right, key, tree->right, more);\n            less_eq = update(tree);\n\
    \        } else {\n            split_upper(tree->left, key, less_eq, tree->left);\n\
    \            more = update(tree);\n        }\n    }\n\n    static Node* erase_one(Node*\
    \ node, const T key, bool& deleted) {\n        if (!node) return nullptr;\n  \
    \      if (node->key == key) {\n            deleted = true;\n            Node*\
    \ res = merge(node->left, node->right);\n            node->left = node->right\
    \ = nullptr;\n            delete node;\n            return res;\n        }\n \
    ...
    \   template<class Container>\n    Additive_Treap(const Container& container)\
    ...
    \ {\n        Node* cur = root;\n        int count = 0;\n        T sum = T(0);\n\
    \        while (cur) {\n            bool condition = equal ? (cur->key <= x) :\
    \ (cur->key < x);\n            if (condition) {\n                count += get_size(cur->left)\
    \ + 1;\n                sum += get_weight(cur->left) + cur->key;\n           \
    \     cur = cur->right;\n            } else {\n                cur = cur->left;\n\
    \            }\n        }\n        return {count, sum};\n    }\n\n    /// @brief\
    \ l \u4EE5\u4E0A r \u672A\u6E80\u306E\u5143\u306E\u500B\u6570\u3068\u7DCF\u548C\
    \u3092\u6C42\u3081\u308B.\n    pair<int, T> query_range(const T l, const T r,\
    \ bool l_equal = true, bool r_equal = false) const {\n        if (l > r || (l\
    \ == r && (!l_equal || !r_equal))) return {0, T(0)};\n        auto upper = query(r,\
    ...
    \ : std::nullopt;\n    }\n\n    /// @brief x \u672A\u6E80\uFF08\u307E\u305F\u306F\
    \u4EE5\u4E0B\uFF09\u306E\u30AD\u30FC\u306E\u3046\u3061\u6700\u5927\u306E\u3082\
    \u306E\u3092\u6C42\u3081\u308B.\n    std::optional<T> previous(const T x, bool\
    ...
    \u5927\u304D\u3044\uFF08\u307E\u305F\u306F\u4EE5\u4E0A\uFF09\u306E\u5143\u306E\
    \u7DCF\u548C\u3092\u6C42\u3081\u308B.\n    T more_sum(const T x, bool equal =\
    \ false) const {\n        return all_sum() - less_sum(x, !equal);\n    }\n\n \
    \   /// @brief l \u4EE5\u4E0A r \u672A\u6E80\u306E\u5143\u306E\u7DCF\u548C\u3092\
    \u6C42\u3081\u308B.\n    T range_sum(const T l, const T r, bool l_equal = true,\
    \ bool r_equal = false) const {\n        if (l > r || (l == r && (!l_equal ||\
    \ !r_equal))) return T(0);\n        T upper = less_sum(r, r_equal);\n        T\
    \ lower = less_sum(l, !l_equal);\n        return upper - lower;\n    }\n\n   \
    \ /// @brief \u5168\u3066\u306E\u5143\u306E\u7DCF\u548C\u3092\u6C42\u3081\u308B\
    .\n    T all_sum() const { return get_weight(root); }\n\n    /// @brief x \u3088\
    \u308A\u5927\u304D\u3044\u5143\u306E\u500B\u6570\u3092\u6C42\u3081\u308B.\n  \
    \  int count_more(const T x, bool equal = false) const {\n        return size()\
    \ - count_less(x, !equal);\n    }\n\n    /// @brief l \u4EE5\u4E0A r \u672A\u6E80\
    \u306E\u5143\u306E\u6570\u3092\u6C42\u3081\u308B.\n    int count_range(const T\
    \ l, const T r, bool l_equal = true, bool r_equal = false) const {\n        if\
    \ (l > r || (l == r && (!l_equal || !r_equal))) return 0;\n        int upper =\
    \ count_less(r, r_equal);\n        int lower = count_less(l, !l_equal);\n    \
    \    return std::max(0, upper - lower);\n    }\n\n    /// @brief \u5148\u982D\
    \ k \u500B\u306E\u8981\u7D20\u306E\u7DCF\u548C\u3092\u6C42\u3081\u308B.\n    T\
    \ first_sum(int k) const {\n        if (k <= 0) return T(0);\n        if (k >=\
    \ (int)size()) return all_sum();\n        Node* cur = root;\n        T res = T(0);\n\
    ...
    \ (0-indexed) \u306E\u30AD\u30FC\u3092\u53D6\u5F97\u3059\u308B.\n    T kth(int\
    \ k) const {\n        if (k < 0) k += size();\n        if (k < 0 || k >= (int)size())\
    \ throw std::out_of_range(\"Additive_Treap::kth : Index out of range.\");\n\n\
...
layout: document
redirect_from:
- /library/Data_Structure/Additive_Treap.hpp
- /library/Data_Structure/Additive_Treap.hpp.html
title: "key \u3092 1 \u3064\u524A\u9664\u3059\u308B."
---
