...
data:
  ...
  attributes:
    ...
    links: []
  bundledCode: "#line 2 \"Data_Structure/Ordered_Multiset.hpp\"\n\n#line 2 \"template/template.hpp\"\
    \n\nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n#include\
    \ <algorithm>\n#include <array>\n#include <bitset>\n#include <cassert>\n#include\
    \ <cctype>\n#include <cfenv>\n#include <cfloat>\n#include <chrono>\n#include <cinttypes>\n\
    #include <climits>\n#include <cmath>\n#include <complex>\n#include <concepts>\n\
    ...
    \    }\n};\n#line 4 \"Data_Structure/Ordered_Multiset.hpp\"\n#include <ext/pb_ds/assoc_container.hpp>\n\
    ...
    \n    order_tree t;\n    I id = 0;\n\n    public:\n    // \u30B3\u30F3\u30B9\u30C8\
    \u30E9\u30AF\u30BF\n\n    Ordered_Multiset(): t(), id(0) {};\n\n    Ordered_Multiset(std::initializer_list<T>\
    \ init_list) : t(), id(0) {\n        for (const auto& x : init_list) insert(x);\n\
    \    }\n\n    template<class Iterator>\n    Ordered_Multiset(Iterator first, Iterator\
    \ last) : t(), id(0) {\n        for (auto it = first; it != last; ++it) insert(*it);\n\
    \    }\n\n    template<class Container>\n    Ordered_Multiset(const Container&\
    \ container) : t(), id(0) {\n        // C++11 \u306E\u7BC4\u56F2\u30D9\u30FC\u30B9\
    \ for \u30EB\u30FC\u30D7\u3092\u4F7F\u3044\u3001\u5185\u90E8\u306E\u8981\u7D20\
    ...
    \ true;\n    }\n\n    // \u524A\u9664\u7CFB\u30E1\u30BD\u30C3\u30C9\n\n    ///\
    \ @brief x \u304C\u5B58\u5728\u3059\u308B\u306A\u3089\u3070, x \u3092 1 \u500B\
    \u6D88\u3059.\n    /// @param x \u524A\u9664\u5024\n    /// @return \u524A\u9664\
    \u306B\u6210\u529F\u3057\u305F\u3089 `true`.\n    bool erase(const T& x) {\n \
    \       auto it = t.lower_bound({x, -1});\n        if (it != t.end() && it->first\
    \ == x) {\n            t.erase(it);\n            return true;\n        }\n\n \
    \       return false;\n    }\n\n    /// @brief x \u3092\u6D88\u305B\u308B\u3060\
    \u3051\u6D88\u3059.\n    /// @param x \u524A\u9664\u5024\n    /// @return \u524A\
    ...
    \ \u306B\u3059\u308B\u3068, \u300C\u672A\u6E80\u300D\u304C\u300C\u4EE5\u4E0B\u300D\
    \u306B\u306A\u308B.\n    /// @return x \u672A\u6E80\u306E\u5143\u306E\u6570\n\
    \    int count_less(const T& x, bool equal = false) const { // x \u672A\u6E80\u306E\
    \u5143\u306E\u500B\u6570\u3092\u6C42\u3081\u308B.\n        if (equal) return t.order_of_key({x,\
    \ std::numeric_limits<I>::max()}); // x \u4EE5\u4E0B\u306E\u500B\u6570\u3092\u6C42\
    \u3081\u308B\u305F\u3081\u306B\u3001\u5341\u5206\u5927\u304D\u306A ID \u3092\u6307\
    ...
    \ true) - count_less(x, false);\n    }\n\n    /// @brief l \u4EE5\u4E0A r \u672A\
    \u6E80\u306E\u5143\u306E\u6570\u3092\u6C42\u3081\u308B.\n    /// @param l \u4E0B\
    \u9650\n    /// @param r \u4E0A\u9650\n    /// @param l_equal \u4E0B\u9650\u306E\
    \u6761\u4EF6\u306B\u7B49\u53F7\u3092\u8A8D\u3081\u308B\u304B?\n    /// @param\
    \ r_equal \u4E0A\u9650\u306E\u6761\u4EF6\u306B\u7B49\u53F7\u3092\u8A8D\u3081\u308B\
    \u304B?\n    /// @return l \u4EE5\u4E0A r \u672A\u6E80\u306E\u5143\u306E\u6570\
    \n    int count_range(const T& l, const T& r, bool l_equal = true, bool r_equal\
    \ = false) const {\n        if (l > r || (l == r && (!l_equal || !r_equal))) return\
    \ 0;\n\n        int upper = count_less(r, r_equal);\n        int lower = count_less(l,\
    \ !l_equal);\n        return std::max(0, upper - lower);\n    }\n\n    // \u30A4\
    \u30F3\u30C7\u30C3\u30AF\u30B9\u7CFB\u30E1\u30BD\u30C3\u30C9\n\n    /// @brief\
    \ k (0-indexed) \u756A\u76EE\u306E\u5024\u3092\u6C42\u3081\u308B.\n    /// @param\
    \ k \u756A\u53F7\n    /// @return k \u756A\u76EE\u306E\u5024\n    T kth(int k)\
    \ const {\n        if (k < 0) k += size();\n        return t.find_by_order(k)->first;\n\
    \    }\n\n    /// @brief k (0-indexed) \u756A\u76EE\u306E\u5024\u3092\u6C42\u3081\
    \u308B. \u7BC4\u56F2\u5916\u306E\u6642\u306F nullopt.\n    /// @param k \u756A\
    \u53F7\n    /// @return k \u756A\u76EE\u306E\u5024\n    optional<T> safe_kth(int\
    ...
    \u30E1\u30BD\u30C3\u30C9\n\n    /// @brief x \u3088\u308A\u5927\u304D\u3044\u6700\
    \u5C0F\u306E\u5024\u3092\u6C42\u3081\u308B.\n    /// @param x \u57FA\u6E96\u5024\
    \n    /// @param equal `true` \u306B\u3059\u308B\u3068, \u300C\u3088\u308A\u5927\
    \u304D\u3044\u300D\u304C\u300C\u4EE5\u4E0A\u300D\u306B\u306A\u308B.\n    /// @return\
    \ x \u3088\u308A\u5927\u304D\u3044\u6700\u5C0F\u306E\u5024\n    std::optional<T>\
    \ next(const T& x, bool equal = false) const {\n        return safe_kth(count_less(x,\
    \ !equal));\n    }\n\n    /// @brief x \u672A\u6E80\u306E\u6700\u5927\u306E\u5024\
    \u3092\u6C42\u3081\u308B.\n    /// @param x \u57FA\u6E96\u5024\n    /// @param\
    \ equal `true` \u306B\u3059\u308B\u3068, \u300C\u672A\u6E80\u300D\u304C\u300C\u4EE5\
    \u4E0B\u300D\u306B\u306A\u308B.\n    /// @return x \u4EE5\u4E0B\u306E\u6700\u5927\
  ...
  requiredBy: []
  timestamp: '2026-05-22 00:31:37+09:00'
