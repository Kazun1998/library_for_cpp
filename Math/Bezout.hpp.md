...
data:
  ...
  attributes:
    document_title: "1\u6B21\u4E0D\u5B9A\u65B9\u7A0B\u5F0F a x + b y = c \u306E\u89E3\
      \ (x, y) \u3092 1 \u7D44\u898B\u3064\u3051\u308B."
    links: []
  bundledCode: "#line 2 \"Math/Bezout.hpp\"\n\n#line 2 \"template/template.hpp\"\n\
    \nusing namespace std;\n\n// intrinstic\n#include <immintrin.h>\n\n#include <algorithm>\n\
    #include <array>\n#include <bitset>\n#include <cassert>\n#include <cctype>\n#include\
    \ <cfenv>\n#include <cfloat>\n#include <chrono>\n#include <cinttypes>\n#include\
    \ <climits>\n#include <cmath>\n#include <complex>\n#include <concepts>\n#include\
    ...
    .\n    /// @return \u89E3 (x, y). \u89E3\u304C\u5B58\u5728\u3057\u306A\u3044\u5834\
    \u5408\u306F std::nullopt.\n    template<integral T>\n    optional<pair<T, T>>\
    \ Find_Non_Negative_Solution(const T a, const T b, const T c) {\n        auto\
    \ [p, q, g] = Extended_Euclid<T>(a, b);\n        return Find_Non_Negative_Solution<T>(a,\
    \ b, c, {p, q});\n    }\n}\n"
  code: "#pragma once\n\n#include\"../template/template.hpp\"\n\nnamespace bezout\
    \ {\n    /// @brief 1\u6B21\u4E0D\u5B9A\u65B9\u7A0B\u5F0F a x + b y = c \u306E\
    \u89E3 (x, y) \u3092 1 \u7D44\u898B\u3064\u3051\u308B.\n    /// @param hint (p,\
    \ q) \u306F a p + b q = gcd(a, b) \u3092\u6E80\u305F\u3059.\n    /// @return \u89E3\
    \ (x, y). \u89E3\u304C\u5B58\u5728\u3057\u306A\u3044\u5834\u5408\u306F std::nullopt.\n\
